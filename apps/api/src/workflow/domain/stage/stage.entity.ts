...
export interface StageData {
  ...
  isInitial: boolean;
  isFinal: boolean;
  approvalConfig: Record<string, unknown> | undefined;
  assignmentConfig: Record<string, unknown> | undefined;
  deadlineHours: number | undefined;
  notifyOnEnter: boolean;
  notifyOnExit: boolean;
  allowRejection: boolean;
  rejectionTargetStageId: string | undefined;
  metadata: Record<string, unknown>;
  createdAt: Date;
  updatedAt: Date;
}
...
export class StageEntity {
  ...
  public approvalConfig: ApprovalConfig | undefined;
  public assignmentConfig: AssignmentConfig | undefined;
  public deadlineHours: number | undefined;
  public notifyOnEnter: boolean;
  public notifyOnExit: boolean;
  public allowRejection: boolean;
  public rejectionTargetStageId: string | undefined;
